...
BOT_TOKEN = os.environ.get("BOT_TOKEN", '5415197525:AAFkP6zvto3OGwkcy-ysuVUWdRS_Pbn1Vcc')
...
BIN_CHANNEL = os.environ.get("BIN_CHANNEL", -1001610580354)
#  Replit Config
